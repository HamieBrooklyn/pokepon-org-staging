...
(function () {
  ...
  function actionsFor(instance) {
    ...
    return legalActions().map((item, index) => ({ ...item, index })).filter(({ action }) => Object.values(action || {}).some((value) => value === instance.uid || (Array.isArray(value) && value.includes(instance.uid))));
  }
